...
describe('TuxStoreMixinGenerator', function () {
  var TuxStoreMixinGenerator, mockStore1, mockStore2, mockListener1, mockListener2, mockListener3, mockListener4, mockEvent1, mockEvent2, mockEvent3, mockEvent4, mockConnectComposerToStore1, mockConnectComposerToStoreReturn1, mockConnectComposerToStore2, mockConnectComposerToStoreReturn2, mockMixin;
  ...
  describe('mockConnectComposerToStore function', function () {
    describe('single event and listener on mockConnectComposerToStoreReturn1 object', function () {
      ...
      it('should add a change listener for provided event on componentDidMount', function () {
        ...
        expect(mockStore1.addChangeListener.mock.calls[0][0]).toEqual(mockConnectComposerToStoreReturn1.listener);
        expect(mockStore1.addChangeListener.mock.calls[0][1]).toEqual(mockConnectComposerToStoreReturn1.event);
      ...
      it('should remove a change listener for provided event on componentWillUnmount', function () {
        ...
        expect(mockStore1.removeChangeListener.mock.calls[0][0]).toEqual(mockConnectComposerToStoreReturn1.listener);
        expect(mockStore1.removeChangeListener.mock.calls[0][1]).toEqual(mockConnectComposerToStoreReturn1.event);
    ...
    describe('more events than listeners', function () {
      ...
      it('adds listeners and events one for one, until events are greater than listener length, at which point the last listener gets assigned to remaining events on componentDidMount', function () {
        ...
        expect(mockStore1.addChangeListener.mock.calls[0][0]).toEqual(mockConnectComposerToStoreReturn1.listener[0]);
        expect(mockStore1.addChangeListener.mock.calls[0][1]).toEqual(mockConnectComposerToStoreReturn1.event[0]);

        // second call of addChangeListener
        expect(mockStore1.addChangeListener.mock.calls[1][0]).toEqual(mockConnectComposerToStoreReturn1.listener[1]);
        expect(mockStore1.addChangeListener.mock.calls[1][1]).toEqual(mockConnectComposerToStoreReturn1.event[1]);

        // third call of addChangeListener
        expect(mockStore1.addChangeListener.mock.calls[2][0]).toEqual(mockConnectComposerToStoreReturn1.listener[1]);
        expect(mockStore1.addChangeListener.mock.calls[2][1]).toEqual(mockConnectComposerToStoreReturn1.event[2]);

        // fourth call of addChangeListener
        expect(mockStore1.addChangeListener.mock.calls[3][0]).toEqual(mockConnectComposerToStoreReturn1.listener[1]);
        expect(mockStore1.addChangeListener.mock.calls[3][1]).toEqual(mockConnectComposerToStoreReturn1.event[3]);
      });
      ...
      it('removes the mapped change listeners to events, when there are more events than listeners, on componentWillUnmount', function () {
        ...
        expect(mockStore1.removeChangeListener.mock.calls[0][0]).toEqual(mockConnectComposerToStoreReturn1.listener[0]);
        expect(mockStore1.removeChangeListener.mock.calls[0][1]).toEqual(mockConnectComposerToStoreReturn1.event[0]);

        // second call of removeChangeListener
        expect(mockStore1.removeChangeListener.mock.calls[1][0]).toEqual(mockConnectComposerToStoreReturn1.listener[1]);
        expect(mockStore1.removeChangeListener.mock.calls[1][1]).toEqual(mockConnectComposerToStoreReturn1.event[1]);

        // third call of removeChangeListener
        expect(mockStore1.removeChangeListener.mock.calls[2][0]).toEqual(mockConnectComposerToStoreReturn1.listener[1]);
        expect(mockStore1.removeChangeListener.mock.calls[2][1]).toEqual(mockConnectComposerToStoreReturn1.event[2]);

        // fourth call of removeChangeListener
        expect(mockStore1.removeChangeListener.mock.calls[3][0]).toEqual(mockConnectComposerToStoreReturn1.listener[1]);
        expect(mockStore1.removeChangeListener.mock.calls[3][1]).toEqual(mockConnectComposerToStoreReturn1.event[3]);
      });
    });
    ...
    describe('more listeners than events', function () {
      ...
      it('should assign events one for one until there are more listeners than events, at which point the last event will be assigned to remaining listeners on componentDidMount', function () {
        ...
        expect(mockStore1.addChangeListener.mock.calls[2][0]).toEqual(mockConnectComposerToStoreReturn1.listener[2]);
        expect(mockStore1.addChangeListener.mock.calls[2][1]).toEqual(mockConnectComposerToStoreReturn1.event[1]);

        // fourth addChangeListener call
        expect(mockStore1.addChangeListener.mock.calls[3][0]).toEqual(mockConnectComposerToStoreReturn1.listener[3]);
        expect(mockStore1.addChangeListener.mock.calls[3][1]).toEqual(mockConnectComposerToStoreReturn1.event[1]);
      });
      ...
      it('removes the mapped change listeners to events, when there are more listeners than events, on componentWillUnmount', function () {
        ...
        expect(mockStore1.removeChangeListener.mock.calls[2][0]).toEqual(mockConnectComposerToStoreReturn1.listener[2]);
        expect(mockStore1.removeChangeListener.mock.calls[2][1]).toEqual(mockConnectComposerToStoreReturn1.event[1]);

        // fourth removeChangeListener call
        expect(mockStore1.removeChangeListener.mock.calls[3][0]).toEqual(mockConnectComposerToStoreReturn1.listener[3]);
        expect(mockStore1.removeChangeListener.mock.calls[3][1]).toEqual(mockConnectComposerToStoreReturn1.event[1]);
      });
    });
  ...
  describe('array of mockConnectComposerToStore functions', function () {
    beforeEach(function () {
      ...
      mockMixin = TuxStoreMixinGenerator([mockConnectComposerToStore1, mockConnectComposerToStore2]);
    });
    ...
    it('add change listeners to each individual store when multiple stores provided', function () {
      ...
      expect(mockStore2.addChangeListener.mock.calls[0][0]).toEqual(mockConnectComposerToStoreReturn2.listener[0]);
      expect(mockStore2.addChangeListener.mock.calls[0][1]).toEqual(mockConnectComposerToStoreReturn2.event[0]);

      // second call of addChangeListener on mockStore2
      expect(mockStore2.addChangeListener.mock.calls[1][0]).toEqual(mockConnectComposerToStoreReturn2.listener[1]);
      expect(mockStore2.addChangeListener.mock.calls[1][1]).toEqual(mockConnectComposerToStoreReturn2.event[1]);

      // third call of addChangeListener on mockStore2
      expect(mockStore2.addChangeListener.mock.calls[2][0]).toEqual(mockConnectComposerToStoreReturn2.listener[1]);
      expect(mockStore2.addChangeListener.mock.calls[2][1]).toEqual(mockConnectComposerToStoreReturn2.event[2]);
    });
    ...
    it('should remove change listeners on each individual store when multiple stores provided', function () {
      ...
      expect(mockStore2.removeChangeListener.mock.calls[0][0]).toEqual(mockConnectComposerToStoreReturn2.listener[0]);
      expect(mockStore2.removeChangeListener.mock.calls[0][1]).toEqual(mockConnectComposerToStoreReturn2.event[0]);

      // second call of removeChangeListener on mockStore2
      expect(mockStore2.removeChangeListener.mock.calls[1][0]).toEqual(mockConnectComposerToStoreReturn2.listener[1]);
      expect(mockStore2.removeChangeListener.mock.calls[1][1]).toEqual(mockConnectComposerToStoreReturn2.event[1]);

      // third call of removeChangeListener on mockStore2
      expect(mockStore2.removeChangeListener.mock.calls[2][0]).toEqual(mockConnectComposerToStoreReturn2.listener[1]);
      expect(mockStore2.removeChangeListener.mock.calls[2][1]).toEqual(mockConnectComposerToStoreReturn2.event[2]);
    });
  });
