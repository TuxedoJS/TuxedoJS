...
jest.dontMock('tuxx/Animations/Rotate/Clock');
jest.dontMock('tuxx/Animations/Scale/Up');
jest.dontMock('tuxx/Animations/Slide/Up');

describe('Animations', function () {
  var React, createAnimation, Idea, Fade, Fly, Zoom, RotateClock, ScaleUp, SlideUp, TestUtils, ideaComponent, mocks;
  ...
  beforeEach(function () {
    ...
    RotateClock = require('tuxx/Animations/Rotate/Clock');
